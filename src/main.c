...
void print_builtin(){
    printf(
        ...
        "POPS LF@i\n"
        "POPS LF@j\n"
        "JUMPIFEQ substr&isnil LF@s nil@nil\n"
        "JUMPIFEQ substr&isnil LF@i nil@nil\n"
        "JUMPIFEQ substr&isnil LF@j nil@nil\n"
        "STRLEN LF@length LF@s\n"
        "GT LF@compare LF@i LF@length\n"
        "JUMPIFEQ substr&returnnil LF@compare bool@true\n"
        ...
        "JUMPIFNEQ substr&while LF@index LF@j\n"
        "PUSHS LF@output\n"
        "POPFRAME\n"
        "RETURN\n"
        "LABEL substr&returnnil\n"
        "PUSHS nil@nil\n"
        "POPFRAME\n"
        "RETURN\n"
        "LABEL substr&isnil\n"
        ...
        "POPS LF@i\n"
        "STRLEN LF@length LF@s\n"
        "JUMPIFEQ ord$isnil LF@s nil@nil\n"
        "JUMPIFEQ ord$isnil LF@i nil@nil\n"
        "GT LF@compare LF@i LF@length\n"
        "JUMPIFEQ ord$returnnil LF@compare bool@true\n"
        "LT LF@compare LF@i int@1\n"
        "JUMPIFEQ ord$returnnil LF@compare bool@true\n"
        "SUB LF@i LF@i int@1\n"
        "STRI2INT LF@output LF@s LF@i\n"
        "PUSHS LF@output\n"
        "POPFRAME\n"
        "RETURN\n"
        "LABEL ord$returnnil\n"
        ...
        "POPS LF@i\n"
        "MOVE LF@output string@\n"
        "JUMPIFEQ chr$isnil LF@i nil@nil\n"
        "GT LF@compare LF@i int@255\n"
        "JUMPIFEQ chr$returnnil LF@compare bool@true\n"
        "LT LF@compare LF@i int@0\n"
        "JUMPIFEQ chr$returnnil LF@compare bool@true\n"
        "INT2CHAR LF@char LF@i\n"
        "CONCAT LF@output LF@output LF@char\n"
        "PUSHS LF@output\n"
        "POPFRAME\n"
        "RETURN\n"
        "LABEL chr$returnnil\n"
